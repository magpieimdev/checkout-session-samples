...
const generateHeaders = () => {
  return {
    ...
    'Authorization': 'Basic ' + Buffer.from(process.env.MAGPIE_PUBLISHABLE_KEY + ":").toString('base64'),
  }
};
...
app.post('/create-checkout-session', async (req, res) => {
  ...
  const paymentMethods = ['card', 'bdo', 'bpi', 'unionbank', 'alipay', 'gcash', 'paymaya', 'unionpay', 'wechat'];
  ...
  // For full details see https://gist.github.com/domdanao/f922ba3a8c5065de02ce933322852532
  const params = {
    currency: product.currency,
